...
namespace EXMO
{
    public partial class Form4 : Form
    {
        ...
        {
            var quantbuy = double.Parse(balMaster, CultureInfo.InvariantCulture) / 100;
            double quantBuy = quantbuy * double.Parse(textBox1.Text, CultureInfo.InvariantCulture);
        ...
        {
            var quantsell = double.Parse(balSlave, CultureInfo.InvariantCulture) / 100;
